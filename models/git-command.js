class GitCommand {
    ...
    //Command: git status
    status(){        
        const changesCount = Object.keys(this.working_directory.new_changes).length;

        if(changesCount === 0){
            return 'You have 0 change/s.\n';
        }

        const files = this.working_directory.files;
        let fileNames = '';
        ...
        return 'You have ' +changesCount+ ' change/s.'+ fileNames;
        /*
